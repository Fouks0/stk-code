...
{
protected:
    OnlineProfileBase(const std::string &filename) : Screen(filename.c_str()) {m_achievements_tab = NULL;}
...
public:
    ...
    {
        Screen::init();
        m_header->setText(_("Achievements"), false);
    }
    virtual bool onEscapePressed() OVERRIDE {return true;}
